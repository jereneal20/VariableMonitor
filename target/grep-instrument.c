     ...
     int chr;
{
  while (*str)
    {
      if (/*binOp start*/*str == /*binOp end*/chr)
	return (char *) str;
      str++;
    }
  return 0;
...
{
  int i;
  for (/*binOp start*/i = /*binOp end*/0; /*binOp start*/i < /*binOp end*/size; i++)
    /*binOp start*/to[i] = from[i/*binOp end*/];
}
#endif				/* GNU C library.  */

...
exchange (argv)
     char **argv;
{
  int nonopts_size = /*binOp start*/(/*binOp start*/last_nonopt - /*binOp end*/first_nonopt) * sizeof (char */*binOp end*/);
  ...
  my_bcopy ((char *) &argv[last_nonopt], (char *) &argv[first_nonopt],
	    /*binOp start*/(/*binOp start*/optind - /*binOp end*/last_nonopt) * sizeof (char */*binOp end*/));
  my_bcopy ((char *) temp,
	    (char *) &argv[/*binOp start*//*binOp start*/first_nonopt + /*binOp end*/optind - /*binOp end*/last_nonopt],
	    nonopts_size);

  /* Update records for the slots the non-options now occupy.  */

  /*assign start*//*binOp start*/first_nonopt += (/*binOp start*/optind - /*binOp end*/last_nonopt/*assign end*//*binOp end*/);
  /*compound start*//*binOp start*/last_nonopt = /*compound end*//*binOp end*/optind;
}

     ...
     int long_only;
{
  ...
  /*compound start*//*binOp start*/optarg = /*compound end*//*binOp end*/0;
  ...
  if (/*binOp start*/optind == /*binOp end*/0)
    {
      /*compound start*//*binOp start*/first_nonopt = /*binOp start*/last_nonopt = /*binOp start*/optind = /*compound end*//*binOp end*//*binOp end*//*binOp end*/1;

      nextchar = NULL;

      /* Determine how to handle the ordering of options and nonoptions.  */

      if (/*binOp start*/optstring[0] == /*binOp end*/'-')
	{
	  /*compound start*//*binOp start*/ordering = /*compound end*//*binOp end*/RETURN_IN_ORDER;
	  ++optstring;
	}
      else if (/*binOp start*/optstring[0] == /*binOp end*/'+')
	{
	  /*compound start*//*binOp start*/ordering = /*compound end*//*binOp end*/REQUIRE_ORDER;
	  ++optstring;
	}
...

  {
    ...
    if (/*binOp start*/*nextchar == /*binOp end*/'\0')
      ++optind;
    ...
    if (/*binOp start*/temp[1] == /*binOp end*/':')
      {
	if (/*binOp start*/temp[2] == /*binOp end*/':')
	  {
	    /* This is an option that accepts an argument optionally.  */
	    if (/*binOp start*/*nextchar != /*binOp end*/'\0')
	      {
		/*compound start*//*binOp start*/optarg = /*compound end*//*binOp end*/nextchar;
		optind++;
	      }
	    else
	      /*binOp start*/optarg = /*binOp end*/0;
	    nextchar = NULL;
	  }
	else
	  {
	    ...
	    else if (/*binOp start*/optind == /*binOp end*/argc)
	      {
		if (opterr)
		  {
#if 0
		...
		/*compound start*//*binOp start*/optopt = /*compound end*//*binOp end*/c;
		if (/*binOp start*/optstring[0] == /*binOp end*/':')
		  /*binOp start*/c = /*binOp end*/':';
		else
		  /*binOp start*/c = /*binOp end*/'?';
	      }
	    else
		 ...
		 increment it again when taking next ARGV-elt as argument.  */
	      /*binOp start*/optarg = argv[optind++/*binOp end*/];
	    nextchar = NULL;
	  }
      }
    return c;
...
init_syntax_once ()
{
   ...
   for (/*binOp start*/c = /*binOp end*/'a'; /*binOp start*/c <= /*binOp end*/'z'; c++)
     /*binOp start*/re_syntax_table[c] = Sword;
   ...
   /*compound start*//*binOp start*/re_syntax_table['_'] = Sword;
     ...
     struct re_pattern_buffer *bufp;
{
  ...
  /*compound start*//*binOp start*/compile_stack.stack = TALLOC (INIT_COMPILE_STACK_SIZE, compile_stack_elt_t);
  if (/*binOp start*/compile_stack.stack == NULL)
    return REG_ESPACE;

  /*compound start*//*binOp start*/compile_stack.size = INIT_COMPILE_STACK_SIZE;
  ...
  if (/*binOp start*/bufp->allocated == /*binOp end*/0)
	...
	{ /* If zero allocated, but buffer is non-null, try to realloc
        ...
        { /* Caller did not allocate a buffer.  Do it for them.  */
          /*compound start*//*binOp start*/bufp->buffer = TALLOC (INIT_BUF_SIZE, unsigned char);
        }
      if (!bufp->buffer) return REG_ESPACE;

      /*compound start*//*binOp start*/bufp->allocated = INIT_BUF_SIZE;
    }
  ...
  while (/*binOp start*/p != /*binOp end*/pend)
        ...
        case '^':
          {
            if (   /* If at start of pattern, it's an operator.  */
                ...
                || /*binOp start*/syntax & RE_CONTEXT_INDEP_ANCHORS
	...
	case '+':
        case '?':
          if (/*binOp start*/(/*binOp start*/syntax & RE_BK_PLUS_QM)
              || (/*binOp start*/syntax & RE_LIMITED_OPS/*binOp end*/))
            goto normal_char;
        handle_plus:
        case '*':
          ...
          if (!laststart)
            {
              if (/*binOp start*/syntax & RE_CONTEXT_INVALID_OPS)
                return REG_BADRPT;
              else if (!(/*binOp start*/syntax & RE_CONTEXT_INDEP_OPS))
                goto normal_char;
            }

          {
            ...
            for (;;)
              {
                ...
                if (/*binOp start*//*binOp start*/c == /*binOp end*/'*'
                    || (/*binOp start*/!(/*binOp start*/syntax & RE_BK_PLUS_QM) && (/*binOp start*//*binOp start*/c == /*binOp end*/'+' || /*binOp start*/c == /*binOp end*//*binOp end*/'?'/*binOp end*/)/*binOp end*/))
                  ;

                else if (/*binOp start*//*binOp start*/syntax & RE_BK_PLUS_QM  &&  /*binOp start*/c == /*binOp end*//*binOp end*/'\\')
                  {
		    ...
		    && /*binOp end*/zero_times_ok
                    && /*binOp start*/p < /*binOp end*//*binOp end*/pend && TRANSLATE (*p) == TRANSLATE ('\n')
                    && !(/*binOp start*/syntax & RE_DOT_NEWLINE/*binOp end*/))
                  { /* We have .*\n.  */
                    STORE_JUMP (jump, b, laststart);
                    /*compound start*//*binOp start*/keep_string_p = true;
                  }
                else
                  /* Anything else.  */
	...
	case '.':
	    ...
	    GET_BUFFER_SPACE (34);
            ...
            if (/*binOp start*//*binOp start*/(re_opcode_t) b[-2] == /*binOp end*/charset_not
                && (/*binOp start*/syntax & RE_HAT_LISTS_NOT_NEWLINE/*binOp end*/))
              SET_LIST_BIT ('\n');
            ...
            for (;;)
              {
                ...
                if (/*binOp start*/(/*binOp start*/syntax & RE_BACKSLASH_ESCAPE_IN_LISTS) && /*binOp start*/c == /*binOp end*//*binOp end*/'\\')
                  {
                    if (/*binOp start*/p == /*binOp end*/pend) return REG_EESCAPE;
		    ...
		    /* Move past the `-'.  */
                ...
                else if (/*binOp start*//*binOp start*//*binOp start*/syntax & RE_CHAR_CLASSES && /*binOp start*/c == /*binOp end*//*binOp end*/'[' && /*binOp start*/*p == /*binOp end*//*binOp end*/':')
                  { /* Leave room for the null.  */
                    char str[CHAR_CLASS_MAX_LENGTH + /*binOp end*/1];
                    ...
                    for (;;)
                      {
                        ...
                        if (/*binOp start*//*binOp start*//*binOp start*//*binOp start*/c == /*binOp end*/':' || /*binOp start*/c == /*binOp end*//*binOp end*/']' || /*binOp start*/p == /*binOp end*//*binOp end*/pend
                            || /*binOp start*/c1 == CHAR_CLASS_MAX_LENGTH)
                          break;
                    ...
                    if (/*binOp start*//*binOp start*/c == /*binOp end*/':' && /*binOp start*/*p == /*binOp end*//*binOp end*/']')
                      {
                        ...
                        for (/*binOp start*/ch = /*binOp end*/0; /*binOp start*/ch < /*binOp start*/1 << BYTEWIDTH; ch++)
                          {
                            if (   /*binOp start*//*binOp start*//*binOp start*//*binOp start*//*binOp start*//*binOp start*//*binOp start*//*binOp start*//*binOp start*//*binOp start*//*binOp start*/(/*binOp start*/is_alnum  && ISALNUM (ch))
                                || (/*binOp start*/is_alpha  && ISALPHA (ch)/*binOp end*/)
                                || (/*binOp start*/is_blank  && ISBLANK (ch)/*binOp end*/)
                                || (/*binOp start*/is_cntrl  && ISCNTRL (ch)/*binOp end*/)
                                || (/*binOp start*/is_digit  && ISDIGIT (ch)/*binOp end*/)
                                || (/*binOp start*/is_graph  && ISGRAPH (ch)/*binOp end*/)
                                || (/*binOp start*/is_lower  && ISLOWER (ch)/*binOp end*/)
                                || (/*binOp start*/is_print  && ISPRINT (ch)/*binOp end*/)
                                || (/*binOp start*/is_punct  && ISPUNCT (ch)/*binOp end*/)
                                || (/*binOp start*/is_space  && ISSPACE (ch)/*binOp end*/)
                                || (/*binOp start*/is_upper  && ISUPPER (ch)/*binOp end*/)
                                || (/*binOp start*/is_xdigit && ISXDIGIT (ch)/*binOp end*/))
                            SET_LIST_BIT (ch);
                          }
                        /*compound start*//*binOp start*/had_char_class = true;
                      }
                    else
                      {
                        c1++;
                        ...
                        SET_LIST_BIT ('[');
                        SET_LIST_BIT (':');
                        /*compound start*//*binOp start*/had_char_class = false;
                      }
                  }
                else
                  {
	...
	case '(':
          if (/*binOp start*/syntax & RE_NO_BK_PARENS)
            goto handle_open;
          else
            goto normal_char;
        ...
        case '\n':
          if (/*binOp start*/syntax & RE_NEWLINE_ALT)
            goto handle_alt;
          else
            goto normal_char;
	...
	case '|':
          if (/*binOp start*/syntax & RE_NO_BK_VBAR)
            goto handle_alt;
          else
            goto normal_char;
        ...
        case '{':
           if (/*binOp start*//*binOp start*/syntax & RE_INTERVALS && /*binOp start*/syntax & RE_NO_BK_BRACES)
        ...
        case '\\':
          ...
          switch (c)
            ...
            handle_open:
              ...
              if (COMPILE_STACK_FULL)
                { 
                  RETALLOC (compile_stack.stack, compile_stack.size << 1,
                            compile_stack_elt_t);
                  if (/*binOp start*/compile_stack.stack == NULL) return REG_ESPACE;
              ...
              /* These are the values to restore when we hit end of this
                 ...
                 be valid.  */
              COMPILE_STACK_TOP.begalt_offset = /*binOp start*/begalt - bufp->/*compound end*//*binOp end*//*binOp end*/buffer;
              COMPILE_STACK_TOP.fixup_alt_jump 
                = fixup_alt_jump ? /*binOp start*//*binOp start*/fixup_alt_jump - bufp->/*binOp end*/buffer + /*binOp end*/1 : /*compound end*//*binOp end*/0;
              COMPILE_STACK_TOP.laststart_offset = /*binOp start*/b - bufp->/*compound end*//*binOp end*//*binOp end*/buffer;
              COMPILE_STACK_TOP.regnum = /*compound end*//*binOp end*/regnum;

              /* We will eventually replace the 0 with the number of
                 groups inner to this one.  But do not push a
                 start_memory for groups beyond the last one we can
                 represent in the compiled pattern.  */
              if (/*binOp start*/regnum <= MAX_REGNUM)
                {
                  COMPILE_STACK_TOP.inner_group_offset = /*binOp start*//*binOp start*/b - bufp->/*binOp end*/buffer + /*compound end*//*binOp end*//*binOp end*/2;
		 ...
		 clear pending_exact explicitly.  */
	      /*compound start*//*binOp start*/pending_exact = /*compound end*//*binOp end*/0;
            ...
            case ')':
              if (/*binOp start*/syntax & RE_NO_BK_PARENS) goto normal_backslash;

              if (COMPILE_STACK_EMPTY)
                if (/*binOp start*/syntax & RE_UNMATCHED_RIGHT_PAREN_ORD)
                  goto normal_backslash;
                else
                  return REG_ERPAREN;
            ...
            handle_close:
              ...
              assert (compile_stack.avail != 0);
              {
                ...
                compile_stack.avail--;		
                /*compound start*//*binOp start*/begalt = /*binOp start*/bufp->buffer + COMPILE_STACK_TOP./*compound end*//*binOp end*//*binOp end*/begalt_offset;
                /*compound start*//*binOp start*/fixup_alt_jump
                  = COMPILE_STACK_TOP.fixup_alt_jump
                    ? /*binOp start*//*binOp start*/bufp->buffer + COMPILE_STACK_TOP./*binOp end*/fixup_alt_jump - /*binOp end*/1 
                    : /*compound end*//*binOp end*/0;
                /*compound start*//*binOp start*/laststart = /*binOp start*/bufp->buffer + COMPILE_STACK_TOP./*compound end*//*binOp end*//*binOp end*/laststart_offset;
                /*compound start*//*binOp start*/this_group_regnum = COMPILE_STACK_TOP./*compound end*//*binOp end*/regnum;
		/* If we've reached MAX_REGNUM groups, then this open
		   won't actually generate any code, so we'll have to
		   clear pending_exact explicitly.  */
		/*compound start*//*binOp start*/pending_exact = /*compound end*//*binOp end*/0;
                ...
                if (/*binOp start*/this_group_regnum <= MAX_REGNUM)
                  {
                    unsigned char *inner_group_loc
                      = /*binOp start*/bufp->buffer + COMPILE_STACK_TOP./*binOp end*/inner_group_offset;
            ...
            case '|':					/* `\|'.  */
              if (/*binOp start*//*binOp start*/syntax & RE_LIMITED_OPS || /*binOp start*/syntax & RE_NO_BK_VBAR)
                goto normal_backslash;
            handle_alt:
              if (/*binOp start*/syntax & RE_LIMITED_OPS)
                goto normal_char;
            ...
            case '{': 
              /* If \{ is a literal.  */
              if (/*binOp start*//*binOp start*/!(/*binOp start*/syntax & RE_INTERVALS)
                     /* If we're at `\{' and it's not the open-interval 
                        operator.  */
                  || (/*binOp start*/(/*binOp start*/syntax & RE_INTERVALS) && (/*binOp start*/syntax & RE_NO_BK_BRACES/*binOp end*/)/*binOp end*/)
            ...
            handle_interval:
              {
                ...
                if (/*binOp start*/p == /*binOp end*/pend)
                  {
                    if (/*binOp start*/syntax & RE_NO_BK_BRACES)
                ...
                if (/*binOp start*/c == /*binOp end*/',')
                  {
                    ...
                    if (/*binOp start*/upper_bound < /*binOp end*/0) /*binOp start*/upper_bound = RE_DUP_MAX;
                  }
                else
                  /* Interval such as `{1}' => match exactly once. */
                  /*binOp start*/upper_bound = /*binOp end*/lower_bound;

                if (/*binOp start*//*binOp start*//*binOp start*/lower_bound < /*binOp end*/0 || /*binOp start*/upper_bound > RE_DUP_MAX
                ...
                /*compound start*//*binOp start*/pending_exact = /*compound end*//*binOp end*/0;
                /*compound start*//*binOp start*/beg_interval = NULL;
              }
              break;
            ...
            case '6': case '7': case '8': case '9':
              if (/*binOp start*/syntax & RE_NO_BK_REFS)
                goto normal_char;
            ...
            case '+':
            case '?':
              if (/*binOp start*/syntax & RE_BK_PLUS_QM)
                goto handle_plus;
              else
                goto normal_backslash;
	...
	normal_char:
	      ...
	      || /*binOp start*/*pending_exact == /*binOp start*/(/*binOp start*/1 << BYTEWIDTH) - /*binOp end*//*binOp end*//*binOp end*/1

              /* If followed by a repetition operator.  */
              || /*binOp start*/*p == /*binOp end*//*binOp end*/'*' || /*binOp start*/*p == /*binOp end*//*binOp end*/'^'
	      || ((/*binOp start*/syntax & RE_BK_PLUS_QM)
	      ...
	      || (/*binOp start*/(/*binOp start*/syntax & RE_INTERVALS)
                  && ((/*binOp start*/syntax & RE_NO_BK_BRACES)
    ...
    reg_syntax_t syntax;
{
  ...
  return
       ...
       /*binOp start*/(/*binOp start*//*binOp start*/*prev == /*binOp end*/'(' && (/*binOp start*//*binOp start*/syntax & RE_NO_BK_PARENS || /*binOp end*/prev_prev_backslash/*binOp end*/))
       /* After an alternative?  */
    || (/*binOp start*//*binOp start*/*prev == /*binOp end*/'|' && (/*binOp start*//*binOp start*/syntax & RE_NO_BK_VBAR || /*binOp end*/prev_prev_backslash/*binOp end*/)/*binOp end*/);
}
    ...
    int syntax;
{
  ...
  const char *next_next = /*binOp start*//*binOp start*/p + /*binOp end*/1 < /*binOp end*/pend ? /*binOp start*/p + /*binOp end*/1 : NULL;
  
  return
       /* Before a subexpression?  */
       /*binOp start*/(/*binOp start*/syntax & RE_NO_BK_PARENS ? /*binOp start*/*next == /*binOp end*/')'
        : /*binOp start*//*binOp start*/next_backslash && /*binOp end*/next_next && /*binOp start*/*next_next == /*binOp end*//*binOp end*/')')
       /* Before an alternative?  */
    || (/*binOp start*/syntax & RE_NO_BK_VBAR ? /*binOp start*/*next == /*binOp end*/'|'
    ...
    unsigned char *b;
{
  ...
  if (/*binOp start*/range_start > /*binOp end*/range_end)
    return /*binOp start*/syntax & RE_NO_EMPTY_RANGES ? REG_ERANGE : REG_NOERROR;
     ...
     struct re_pattern_buffer *bufp;
{
  ...
  /*compound start*//*binOp start*/bufp->fastmap_accurate = /*compound end*//*binOp end*/1;	    /* It will be when we're done.  */
  /*compound start*//*binOp start*/bufp->can_be_null = /*compound end*//*binOp end*/0;
      
  while (/*binOp start*//*binOp start*/p != /*binOp end*/pend || !FAIL_STACK_EMPTY ())
    {
      if (/*binOp start*/p == /*binOp end*/pend)
        {
          ...
          /* Reset for next path.  */
          /*compound start*//*binOp start*/path_can_be_null = true;
	...
	case exactn:
	  ...
	  break;
        ...
        case charset:
          for (/*binOp start*/j = /*binOp start*//*binOp start*/*p++ * BYTEWIDTH - /*binOp end*//*binOp end*/1; /*binOp start*/j >= /*binOp end*/0; j--)
	    if (/*binOp start*/p[/*binOp start*/j / BYTEWIDTH] & (/*binOp start*/1 << (/*binOp start*/j % BYTEWIDTH/*binOp end*/)/*binOp end*/))
	...
	case charset_not:
	  ...
	  for (/*binOp start*/j = /*binOp start*/*p * BYTEWIDTH; /*binOp start*/j < (/*binOp start*/1 << BYTEWIDTH/*binOp end*/); j++)
            /*binOp start*/fastmap[j] = /*binOp end*/1;
	...
	case wordchar:
	  for (/*binOp start*/j = /*binOp end*/0; /*binOp start*/j < (/*binOp start*/1 << BYTEWIDTH/*binOp end*/); j++)
	    if (SYNTAX (j) == Sword)
	      /*binOp start*/fastmap[j] = /*binOp end*/1;
	  break;
	...
	case notwordchar:
	  ...
	  for (/*binOp start*/j = /*binOp end*/0; /*binOp start*/j < (/*binOp start*/1 << BYTEWIDTH/*binOp end*/); j++)
          ...
          if (!(/*binOp start*/bufp->syntax & RE_DOT_NEWLINE))
            /*binOp start*/fastmap['\n'] = /*binOp end*/0;
	...
	case dummy_failure_jump:
	  ...
	  if (/*binOp start*/j > /*binOp end*/0)
	    ...
	    continue;
          ...
          if (/*binOp start*/!FAIL_STACK_EMPTY () 
          ...
          if (succeed_n_p)
            {
              ...
              /*compound start*//*binOp start*/succeed_n_p = false;
	    }
	...
	case succeed_n:
          ...
          if (/*binOp start*/k == /*binOp end*/0)
	    {
  	      ...
  	      /*compound start*//*binOp start*/succeed_n_p = true;  /* Spaghetti code alert.  */
	...
	default:
      ...
      /* Getting here means we have found the possible starting
         ...
         does these things.  */
      /*compound start*//*binOp start*/path_can_be_null = false;
    ...
    regoff_t *starts, *ends;
{
  if (num_regs)
    {
      /*compound start*//*binOp start*/bufp->regs_allocated = REGS_REALLOCATE;
    ...
    {
      /*compound start*//*binOp start*/bufp->regs_allocated = REGS_UNALLOCATED;
     ...
     int stop;
{
  ...
  for (;;)
	...
	{
	  if (/*binOp start*/range > /*binOp end*/0)	/* Searching forwards.  */
	    {
     ...
     int stop;
{
  ...
  for (/*binOp start*/mcnt = /*binOp end*/1; /*binOp start*/mcnt < /*binOp end*/num_regs; mcnt++)
    {
      /*compound start*//*binOp start*/regstart[mcnt] = /*binOp start*/regend[mcnt] 
        = /*binOp start*/old_regstart[mcnt] = /*binOp start*/old_regend[mcnt] = REG_UNSET_VALUE;
        
      REG_MATCH_NULL_STRING_P (reg_info[mcnt]) = MATCH_NULL_UNSET_VALUE;
      IS_ACTIVE (reg_info[mcnt]) = /*compound end*//*binOp end*/0;
      MATCHED_SOMETHING (reg_info[mcnt]) = /*compound end*//*binOp end*/0;
      EVER_MATCHED_SOMETHING (reg_info[mcnt]) = /*compound end*//*binOp end*/0;
    }
  
  /* We move `string1' into `string2' if the latter's empty -- but not if
     `string1' is null.  */
  if (/*binOp start*//*binOp start*/size2 == /*binOp end*/0 && /*binOp start*/string1 != NULL)
    {
  ...
  for (;;)
	...
	{ /* End of pattern means we might have succeeded.  */
	  ...
	  /* If we haven't matched the entire string, and we want the
              ...
              if (!FAIL_STACK_EMPTY ())
                { /* More failure points to try.  */
                  ...
                  if (/*binOp start*//*binOp start*/!best_regs_set
                      ...
                      || (/*binOp start*/!same_str_p && !MATCHING_IN_FIRST_STRING/*binOp end*/))
                    {
                      /*compound start*//*binOp start*/best_regs_set = true;
          ...
          if (/*binOp start*/regs && !bufp->/*binOp end*/no_sub)
	    {
              ...
              if (/*binOp start*/bufp->regs_allocated == REGS_UNALLOCATED)
                { /* No.  So allocate them with malloc.  We need one
                     extra element beyond `num_regs' for the `-1' marker
                     GNU code uses.  */
                  /*compound start*//*binOp start*/regs->num_regs = MAX (RE_NREGS, num_regs + 1);
                  /*compound start*//*binOp start*/regs->start = TALLOC (regs->num_regs, regoff_t);
                  /*compound start*//*binOp start*/regs->end = TALLOC (regs->num_regs, regoff_t);
                  if (/*binOp start*//*binOp start*/regs->start == NULL || /*binOp start*/regs->end == NULL)
                    return -2;
                  /*compound start*//*binOp start*/bufp->regs_allocated = REGS_REALLOCATE;
                }
              else if (/*binOp start*/bufp->regs_allocated == REGS_REALLOCATE)
              ...
              if (/*binOp start*/regs->num_regs > /*binOp end*/0)
                {
                  ...
                  /*compound start*//*binOp start*/regs->end[0] = (MATCHING_IN_FIRST_STRING ? /*binOp start*/d - /*binOp end*/string1
			          : /*binOp start*//*binOp start*/d - /*binOp end*/string2 + /*binOp end*/size1/*compound end*//*binOp end*/);
                }
              
              /* Go through the first `min (num_regs, regs->num_regs)'
                 registers, since that is all we initialized.  */
	      for (/*binOp start*/mcnt = /*binOp end*/1; /*binOp start*/mcnt < MIN (num_regs, regs->num_regs); mcnt++)
		{
                  if (REG_UNSET (regstart[mcnt]) || REG_UNSET (regend[mcnt]))
                    /*binOp start*/regs->start[mcnt] = /*binOp start*/regs->end[mcnt] = -/*binOp end*//*binOp end*/1;
                  else
                    {
		      /*compound start*//*binOp start*/regs->start[mcnt] = POINTER_TO_OFFSET (regstart[mcnt]);
                      /*compound start*//*binOp start*/regs->end[mcnt] = POINTER_TO_OFFSET (regend[mcnt]);
                    }
		}
          ...
          /*compound start*//*binOp start*/mcnt = /*binOp start*//*binOp start*/d - /*binOp end*/pos - (MATCHING_IN_FIRST_STRING 
			    ? string1 
	...
	case anychar:
          ...
          if (/*binOp start*/(/*binOp start*/!(/*binOp start*/bufp->syntax & RE_DOT_NEWLINE) && TRANSLATE (*d) == /*binOp end*//*binOp end*/'\n')
              || (/*binOp start*//*binOp start*/bufp->syntax & RE_DOT_NOT_NULL && TRANSLATE (*d) == /*binOp end*//*binOp end*/'\000'/*binOp end*/))
	    goto fail;
	...
	case charset_not:
	  {
	    ...
	    PREFETCH ();
	    /*compound start*//*binOp start*/c = TRANSLATE (*d); /* The character to match.  */

            /* Cast to `unsigned' instead of `unsigned char' in case the
               bit list is a full 32 bytes long.  */
	    if (/*binOp start*//*binOp start*/c < (unsigned) (/*binOp start*/*p * BYTEWIDTH/*binOp end*/)
		&& /*binOp start*/p[/*binOp start*/1 + /*binOp start*/c / BYTEWIDTH] & (/*binOp start*/1 << (/*binOp start*/c % BYTEWIDTH/*binOp end*/)/*binOp end*//*binOp end*/))
	  ...
	  /*compound start*//*binOp start*/p1 = /*compound end*//*binOp end*/p;		/* To send to group_match_null_string_p.  */
          ...
          /*compound start*//*binOp start*/old_regstart[*p] = REG_MATCH_NULL_STRING_P (reg_info[*p])
	  ...
	  DEBUG_PRINT2 ("  regstart: %d\n", POINTER_TO_OFFSET (regstart[*p]));
          ...
          IS_ACTIVE (reg_info[*p]) = /*compound end*//*binOp end*/1;
          MATCHED_SOMETHING (reg_info[*p]) = /*compound end*//*binOp end*/0;
          ...
          /* If nothing was active before, this is the new lowest active
             register.  */
          if (/*binOp start*/lowest_active_reg == NO_LOWEST_ACTIVE_REG)
	...
	case stop_memory:
	  DEBUG_PRINT3 ("EXECUTING stop_memory %d (%d):\n", *p, p[1]);
          ...
          /* We need to save the string position the last time we were at
             ...
             the string in case this attempt to match fails.  */
          /*compound start*//*binOp start*/old_regend[*p] = REG_MATCH_NULL_STRING_P (reg_info[*p])
	  ...
	  DEBUG_PRINT2 ("      regend: %d\n", POINTER_TO_OFFSET (regend[*p]));
          ...
          IS_ACTIVE (reg_info[*p]) = /*compound end*//*binOp end*/0;
          
          /* If this was the only register active, nothing is active
             anymore.  */
          if (/*binOp start*/lowest_active_reg == /*binOp end*/highest_active_reg)
            {
              /*compound start*//*binOp start*/lowest_active_reg = NO_LOWEST_ACTIVE_REG;
              /*compound start*//*binOp start*/highest_active_reg = NO_HIGHEST_ACTIVE_REG;
            }
          else
            { /* We must scan for the new highest active register, since
              ...
              while (/*binOp start*//*binOp start*/r > /*binOp end*/0 && !IS_ACTIVE (reg_info[r]))
                r--;
          ...
          /* If just failed to match something this time around with a
             ...
             last match.  */
          if (/*binOp start*/(/*binOp start*/!MATCHED_SOMETHING (reg_info[*p])
	      ...
	      && /*binOp start*/(/*binOp start*/p + /*binOp end*/2) < /*binOp end*//*binOp end*/pend)              
            {
              ...
              switch ((re_opcode_t) *p1++)
                {
                  case jump_n:
		    /*case comp start*//*binOp start*/is_a_jump_n = true;
                  case pop_failure_jump:
		  case maybe_pop_jump:
		  case jump:
		  case dummy_failure_jump:
                  ...
                  && /*binOp start*/(re_opcode_t) p1[3] == /*binOp end*//*binOp end*/start_memory && /*binOp start*/p1[4] == */*binOp end*//*binOp end*/p)
		{
                  ...
                  if (EVER_MATCHED_SOMETHING (reg_info[*p]))
		    {
		      unsigned r; 
                      ...
                      EVER_MATCHED_SOMETHING (reg_info[*p]) = /*compound end*//*binOp end*/0;
	...
	/* \<digit> has been turned into a `duplicate' command which is
        ...
        case duplicate:
	  {
	    ...
	    /* Can't back reference a group which we've never matched.  */
            ...
            /*compound start*//*binOp start*/dend2 = ((FIRST_STRING_P (regstart[regno]) 
	...
	case on_failure_jump:
	   ...
	   We change it to either `pop_failure_jump' or `jump'.  */
	    ...
	    while (/*binOp start*//*binOp start*//*binOp start*/p2 + /*binOp end*/2 < /*binOp end*/pend
	      ...
	      /*binOp start*/p2 += /*binOp end*/3;			/* Skip over args, too.  */
		...
		/*compound start*//*binOp start*/p1 = /*binOp start*/p + /*compound end*//*binOp end*//*binOp end*/mcnt;
			 ...
			 || /*binOp start*/(re_opcode_t) p1[3] == /*binOp end*//*binOp end*/charset_not)
		  {
		    ...
		    if (/*binOp start*//*binOp start*/c < (unsigned char) (/*binOp start*/p1[4] * BYTEWIDTH/*binOp end*/)
			&& /*binOp start*/p1[/*binOp start*/5 + /*binOp start*/c / BYTEWIDTH] & (/*binOp start*/1 << (/*binOp start*/c % BYTEWIDTH/*binOp end*/)/*binOp end*//*binOp end*/))
		      /*binOp start*/not = !/*binOp end*/not;
	  ...
	  /*assign start*//*binOp start*/p -= /*assign end*//*binOp end*/2;		/* Point at relative address again.  */
	...
	unconditional_jump:
	  ...
	  /*assign start*//*binOp start*/p += /*assign end*//*binOp end*/mcnt;				/* Do the jump.  */
	...
	case wordbeg:
	  ...
	  if (WORDCHAR_P (d) && (AT_STRINGS_BEG (d) || !WORDCHAR_P (d - 1)/*binOp end*/))
	    break;
          goto fail;

	case wordend:
          DEBUG_PRINT1 ("EXECUTING wordend.\n");
	  if (/*binOp start*//*binOp start*/!AT_STRINGS_BEG (d) && WORDCHAR_P (d - 1)
              && (/*binOp start*/!WORDCHAR_P (d) || AT_STRINGS_END (d)/*binOp end*/))
	    break;
          goto fail;
	  ...
	  if (/*binOp start*/mcnt >= /*binOp end*/0)
	    {
		  ...
		  p1++;
              ...
              /*assign start*//*binOp start*/p1 += /*assign end*//*binOp end*/mcnt;	/* Get past the n-th alternative.  */
            } /* if mcnt > 0 */
          break;
  ...
  switch ((re_opcode_t) *p1++)
    ...
    case start_memory:
      ...
      if (REG_MATCH_NULL_STRING_P (reg_info[reg_no]) == MATCH_NULL_UNSET_VALUE)
        REG_MATCH_NULL_STRING_P (reg_info[reg_no]) = /*binOp end*/ret;
    ...
    const char *s;
{
  ...
  if (!re_comp_buf.buffer)
    {
      /*compound start*//*binOp start*/re_comp_buf.buffer = (unsigned char *) malloc (200/*compound end*//*binOp end*/);
      if (/*binOp start*/re_comp_buf.buffer == NULL)
        return "Memory exhausted";
      /*compound start*//*binOp start*/re_comp_buf.allocated = /*compound end*//*binOp end*/200;

      /*compound start*//*binOp start*/re_comp_buf.fastmap = (char *) malloc (/*binOp start*/1 << BYTEWIDTH/*compound end*//*binOp end*/);
      if (/*binOp start*/re_comp_buf.fastmap == NULL)
	return "Memory exhausted";
    }
  ...
  /*compound start*//*binOp start*/re_comp_buf.newline_anchor = /*compound end*//*binOp end*/1;

  /*compound start*//*binOp start*/ret = regex_compile (s, strlen (s), re_syntax_options, &re_comp_buf/*compound end*//*binOp end*/);
    ...
    const char *s;
{
  ...
  return
    /*binOp start*/0 <= re_search (&re_comp_buf, s, len, 0, len, (struct re_registers *) 0/*binOp end*/);
}
    ...
    int cflags;
{
  reg_errcode_t ret;
  unsigned syntax
    = (/*binOp start*/cflags & REG_EXTENDED) ?
  ...
  if (/*binOp start*/cflags & REG_ICASE)
    {
      unsigned i;
      
      /*compound start*//*binOp start*/preg->translate = (char *) malloc (CHAR_SET_SIZE/*compound end*//*binOp end*/);
      if (/*binOp start*/preg->translate == NULL)
        return (int) REG_ESPACE;

      /* Map uppercase characters to corresponding lowercase ones.  */
      for (/*binOp start*/i = /*binOp end*/0; /*binOp start*/i < CHAR_SET_SIZE; i++)
        /*binOp start*/preg->translate[i] = ISUPPER (i) ? tolower (i) : /*binOp end*/i;
    }
  else
    /*binOp start*/preg->translate = NULL;

  /* If REG_NEWLINE is set, newlines are treated differently.  */
  if (/*binOp start*/cflags & REG_NEWLINE)
    { /* REG_NEWLINE implies neither . nor [^...] match newline.  */
      /*assign start*//*binOp start*/syntax &= ~RE_DOT_NEWLINE;
      /*assign start*//*binOp start*/syntax |= RE_HAT_LISTS_NOT_NEWLINE;
  ...
  /*compound start*//*binOp start*/preg->no_sub = !!(/*binOp start*/cflags & REG_NOSUB/*compound end*//*binOp end*/);
...
regfree (preg)
    regex_t *preg;
{
  if (/*binOp start*/preg->buffer != NULL)
    free (preg->buffer);
  /*compound start*//*binOp start*/preg->buffer = NULL;
  
  /*compound start*//*binOp start*/preg->allocated = /*compound end*//*binOp end*/0;
  /*compound start*//*binOp start*/preg->used = /*compound end*//*binOp end*/0;

  if (/*binOp start*/preg->fastmap != NULL)
    free (preg->fastmap);
  /*compound start*//*binOp start*/preg->fastmap = NULL;
  /*compound start*//*binOp start*/preg->fastmap_accurate = /*compound end*//*binOp end*/0;

  if (/*binOp start*/preg->translate != NULL)
    free (preg->translate);
  /*compound start*//*binOp start*/preg->translate = NULL;
}
...
tstbit(b, c)
     ...
     charclass c;
{
  return /*binOp start*/c[/*binOp start*/b / INTBITS] & /*binOp start*/1 << /*binOp start*/b % INTBITS;
}
...
setbit(b, c)
     ...
     charclass c;
{
  /*assign start*//*binOp start*/c[/*binOp start*/b / INTBITS] |= /*binOp start*/1 << /*binOp start*/b % INTBITS;
}
...
clrbit(b, c)
     ...
     charclass c;
{
  /*assign start*//*binOp start*/c[/*binOp start*/b / INTBITS] &= ~(/*binOp start*/1 << /*binOp start*/b % INTBITS/*assign end*//*binOp end*/);
}
     ...
     charclass dst;
{
  ...
  for (/*binOp start*/i = /*binOp end*/0; /*binOp start*/i < CHARCLASS_INTS; ++i)
...
lex()
{
  ...
  for (/*binOp start*/i = /*binOp end*/0; /*binOp start*/i < /*binOp end*/2; ++i)
	...
	case '^':
	  if (backslash)
	    goto normal_char;
	  if (/*binOp start*//*binOp start*//*binOp start*//*binOp start*/syntax_bits & RE_CONTEXT_INDEP_ANCHORS
	...
	case '$':
	  if (backslash)
	    goto normal_char;
	  if (/*binOp start*//*binOp start*//*binOp start*//*binOp start*//*binOp start*/syntax_bits & RE_CONTEXT_INDEP_ANCHORS
	      || /*binOp start*/lexleft == /*binOp end*//*binOp end*/0
	      || (/*binOp start*/syntax_bits & RE_NO_BK_PARENS
	      ...
	      || (/*binOp start*/syntax_bits & RE_NO_BK_VBAR
		  ? /*binOp start*//*binOp start*/lexleft > /*binOp end*/0 && /*binOp start*/*lexptr == /*binOp end*//*binOp end*/'|'
		  : /*binOp start*//*binOp start*//*binOp start*/lexleft > /*binOp end*/1 && /*binOp start*/lexptr[0] == /*binOp end*//*binOp end*/'\\' && /*binOp start*/lexptr[1] == /*binOp end*//*binOp end*/'|'/*binOp end*/)
	      || (/*binOp start*//*binOp start*/(/*binOp start*/syntax_bits & RE_NEWLINE_ALT)
	...
	case '8':
	case '9':
	  if (/*binOp start*/backslash && !(/*binOp start*/syntax_bits & RE_NO_BK_REFS/*binOp end*/))
	    {
	      /*compound start*//*binOp start*/laststart = /*compound end*//*binOp end*/0;
	...
	case '?':
	  if (/*binOp start*/syntax_bits & RE_LIMITED_OPS)
	    goto normal_char;
	  if (/*binOp start*/backslash != (/*binOp start*/(/*binOp start*/syntax_bits & RE_BK_PLUS_QM) != /*binOp end*/0/*binOp end*/))
	    goto normal_char;
	  if (/*binOp start*/!(/*binOp start*/syntax_bits & RE_CONTEXT_INDEP_OPS) && /*binOp end*/laststart)
	    goto normal_char;
	...
	case '{':
	  if (!(/*binOp start*/syntax_bits & RE_INTERVALS))
	    goto normal_char;
	  if (/*binOp start*/backslash != (/*binOp start*/(/*binOp start*/syntax_bits & RE_NO_BK_BRACES) == /*binOp end*/0/*binOp end*/))
	    goto normal_char;
	  ...
	  if (!(/*binOp start*/syntax_bits & RE_NO_BK_BRACES))
	    {
	      if (/*binOp start*/c != /*binOp end*/'\\')
		dfaerror("malformed repeat count");
	      FETCH(c, "unfinished repeat count");
	...
	case '|':
	  if (/*binOp start*/syntax_bits & RE_LIMITED_OPS)
	    goto normal_char;
	  if (/*binOp start*/backslash != (/*binOp start*/(/*binOp start*/syntax_bits & RE_NO_BK_VBAR) == /*binOp end*/0/*binOp end*/))
	    goto normal_char;
	  /*compound start*//*binOp start*/laststart = /*compound end*//*binOp end*/1;
	  return /*binOp start*/lasttok = /*binOp end*/OR;

	case '\n':
	  if (/*binOp start*//*binOp start*//*binOp start*/syntax_bits & RE_LIMITED_OPS
	      || /*binOp end*/backslash
	      || !(/*binOp start*/syntax_bits & RE_NEWLINE_ALT/*binOp end*/))
	    goto normal_char;
	  /*compound start*//*binOp start*/laststart = /*compound end*//*binOp end*/1;
	  return /*binOp start*/lasttok = /*binOp end*/OR;

	case '(':
	  if (/*binOp start*/backslash != (/*binOp start*/(/*binOp start*/syntax_bits & RE_NO_BK_PARENS) == /*binOp end*/0/*binOp end*/))
	    goto normal_char;
	  ++parens;
	  /*compound start*//*binOp start*/laststart = /*compound end*//*binOp end*/1;
	...
	case ')':
	  if (/*binOp start*/backslash != (/*binOp start*/(/*binOp start*/syntax_bits & RE_NO_BK_PARENS) == /*binOp end*/0/*binOp end*/))
	    goto normal_char;
	  if (/*binOp start*//*binOp start*/parens == /*binOp end*/0 && /*binOp start*/syntax_bits & RE_UNMATCHED_RIGHT_PAREN_ORD)
	    goto normal_char;
	  --parens;
	  /*compound start*//*binOp start*/laststart = /*compound end*//*binOp end*/0;
	...
	case '.':
	  ...
	  zeroset(ccl);
	  notset(ccl);
	  if (!(/*binOp start*/syntax_bits & RE_DOT_NEWLINE))
	    clrbit('\n', ccl);
	  if (/*binOp start*/syntax_bits & RE_DOT_NOT_NULL)
	    clrbit('\0', ccl);
	  /*compound start*//*binOp start*/laststart = /*compound end*//*binOp end*/0;
	...
	case 'W':
	  if (!backslash)
	    goto normal_char;
	  zeroset(ccl);
	  for (/*binOp start*/c2 = /*binOp end*/0; /*binOp start*/c2 < NOTCHAR; ++c2)
	    if (ISALNUM(c2))
	      setbit(c2, ccl);
	...
	case '[':
	  ...
	  do
	    {
		 ...
		 dfa is ever called. */
	      if (/*binOp start*//*binOp start*/c == /*binOp end*/'[' && (/*binOp start*/syntax_bits & RE_CHAR_CLASSES/*binOp end*/))
		for (/*binOp start*/c1 = /*binOp end*/0; prednames[c1].name; ++c1)
	      ...
	      if (/*binOp start*//*binOp start*/c == /*binOp end*/'\\' && (/*binOp start*/syntax_bits & RE_BACKSLASH_ESCAPE_IN_LISTS/*binOp end*/))
		FETCH(c, "Unbalanced [");
	      FETCH(c1, "Unbalanced [");
	      if (/*binOp start*/c1 == /*binOp end*/'-')
		{
		  ...
		  if (/*binOp start*/c2 == /*binOp end*/']')
		  ...
		  else
		    {
			  ...
			  && (/*binOp start*/syntax_bits & RE_BACKSLASH_ESCAPE_IN_LISTS/*binOp end*/))
			FETCH(c2, "Unbalanced [");
		      FETCH(c1, "Unbalanced [");
		    }
		}
	  ...
	  if (invert)
	    {
	      notset(ccl);
	      if (/*binOp start*/syntax_bits & RE_HAT_LISTS_NOT_NEWLINE)
		clrbit('\n', ccl);
	    }
	  /*compound start*//*binOp start*/laststart = /*compound end*//*binOp end*/0;
	  return /*binOp start*/lasttok = /*binOp start*/CSET + charclass_index(ccl/*binOp end*//*binOp end*/);
	...
	normal_char:
	  ...
	  if (/*binOp start*/case_fold && ISALPHA(c))
	    {
	      zeroset(ccl);
	      setbit(c, ccl);
	      if (isupper(c))
...
atom()
{
  if (/*binOp start*//*binOp start*//*binOp start*//*binOp start*//*binOp start*//*binOp start*//*binOp start*//*binOp start*/(/*binOp start*//*binOp start*/tok >= /*binOp end*/0 && /*binOp start*/tok < NOTCHAR) || /*binOp start*/tok >= /*binOp end*//*binOp end*/CSET || /*binOp start*/tok == /*binOp end*//*binOp end*/BACKREF
     ...
     position_set *s;
{
  ...
  for (/*binOp start*/i = /*binOp end*/0; /*binOp start*//*binOp start*/i < s->/*binOp end*/nelem && /*binOp start*/p.index < s->elems[i].index; ++i)
    ;
  if (/*binOp start*//*binOp start*/i < s->/*binOp end*/nelem && /*binOp start*/p.index == s->elems[i].index)
     ...
     position_set *m;
{
  ...
  while (/*binOp start*//*binOp start*/i < s1->/*binOp end*/nelem && /*binOp start*/j < s2->/*binOp end*//*binOp end*/nelem)
    if (/*binOp start*/s1->elems[i].index > s2->elems[j].index)
      /*binOp start*/m->elems[m->nelem++] = s1->elems[i++/*binOp end*/];
    else if (/*binOp start*/s1->elems[i].index < s2->elems[j].index)
     ...
     position_set *s;
{
  ...
  for (/*binOp start*/i = /*binOp end*/0; /*binOp start*/i < s->/*binOp end*/nelem; ++i)
    if (/*binOp start*/p.index == s->elems[i].index)
      break;
     ...
     int letter;
{
  ...
  for (/*binOp start*/i = /*binOp end*/0; /*binOp start*/i < s->/*binOp end*/nelem; ++i)
    /*binOp start*/hash ^= /*binOp start*/s->elems[i].index + s->elems[i]./*binOp end*//*binOp end*/constraint;
  ...
  for (/*binOp start*/i = /*binOp end*/0; /*binOp start*/i < d->/*binOp end*/sindex; ++i)
	...
	if (/*binOp start*//*binOp start*/s->elems[j].constraint
	    ...
	    || /*binOp start*/s->elems[j].index != d->states[i].elems.elems[j].index)
	  break;
  ...
  for (/*binOp start*/j = /*binOp end*/0; /*binOp start*/j < s->/*binOp end*/nelem; ++j)
    if (/*binOp start*/d->tokens[s->elems[j].index] < /*binOp end*/0)
      {
	...
	if (! d->states[i].first_end)
	  /*binOp start*/d->states[i].first_end = d->tokens[s->elems[j].index/*binOp end*/];
      }
    else if (/*binOp start*/d->tokens[s->elems[j].index] == /*binOp end*/BACKREF)
      {
	/*compound start*//*binOp start*/d->states[i].constraint = NO_CONSTRAINT;
     ...
     struct dfa *d;
{
  ...
  for (/*binOp start*/i = /*binOp end*/0; /*binOp start*/i < s->/*binOp end*/nelem; ++i)
    if (/*binOp start*//*binOp start*//*binOp start*/d->tokens[s->elems[i].index] >= NOTCHAR
	&& /*binOp start*/d->tokens[s->elems[i].index] != /*binOp end*//*binOp end*/BACKREF
	&& /*binOp start*/d->tokens[s->elems[i].index] < /*binOp end*//*binOp end*/CSET)
      {
	...
	/*compound start*//*binOp start*/visited[old.index] = /*compound end*//*binOp end*/1;
	switch (d->tokens[old.index])
	  {
	  case BEGLINE:
	    /*case assign start*//*binOp start*/p.constraint &= BEGLINE_CONSTRAINT;
	    break;
	  case ENDLINE:
	    /*case assign start*//*binOp start*/p.constraint &= ENDLINE_CONSTRAINT;
	    break;
	  case BEGWORD:
	    /*case assign start*//*binOp start*/p.constraint &= BEGWORD_CONSTRAINT;
	    break;
	  case ENDWORD:
	    /*case assign start*//*binOp start*/p.constraint &= ENDWORD_CONSTRAINT;
	    break;
	  case LIMWORD:
	    /*case assign start*//*binOp start*/p.constraint &= LIMWORD_CONSTRAINT;
	    break;
	  case NOTLIMWORD:
	    /*case assign start*//*binOp start*/p.constraint &= NOTLIMWORD_CONSTRAINT;
	    break;
	  default:
	    break;
	  }
	for (/*binOp start*/j = /*binOp end*/0; /*binOp start*/j < d->follows[old.index]./*binOp end*/nelem; ++j)
	  {
	    /*compound start*//*binOp start*/p.index = d->follows[old.index].elems[j].index;
	    insert(p, s);
	  }
     ...
     int searchflag;
{
  ...
  for (/*binOp start*/i = /*binOp end*/0; /*binOp start*/i < d->/*binOp end*/tindex; ++i)
	...
	/*compound start*//*binOp start*/firstpos->index = /*binOp start*/lastpos->index = /*compound end*//*binOp end*//*binOp end*/i;
	/*compound start*//*binOp start*/firstpos->constraint = /*binOp start*/lastpos->constraint = NO_CONSTRAINT;
  ...
  for (/*binOp start*/i = /*binOp end*/0; /*binOp start*/i < d->/*binOp end*/tindex; ++i)
    if (/*binOp start*//*binOp start*//*binOp start*/d->tokens[i] < NOTCHAR || /*binOp start*/d->tokens[i] == /*binOp end*//*binOp end*/BACKREF
     ...
     int trans[];
{
  ...
  if (! initialized)
    {
      /*compound start*//*binOp start*/initialized = /*compound end*//*binOp end*/1;
      for (/*binOp start*/i = /*binOp end*/0; /*binOp start*/i < NOTCHAR; ++i)
	if (ISALNUM(i))
	  setbit(i, letters);
      setbit('\n', newline);
    }
  ...
  for (/*binOp start*/i = /*binOp end*/0; /*binOp start*/i < d->states[s].elems./*binOp end*/nelem; ++i)
    {
      ...
      if (/*binOp start*//*binOp start*/d->tokens[pos.index] >= /*binOp end*/0 && /*binOp start*/d->tokens[pos.index] < NOTCHAR)
	setbit(d->tokens[pos.index], matches);
      else if (/*binOp start*/d->tokens[pos.index] >= /*binOp end*/CSET)
	copyset(d->charclasses[/*binOp start*/d->tokens[pos.index] - /*binOp end*/CSET], matches);
      else
	continue;
      ...
      if (/*binOp start*/pos.constraint != /*binOp end*/0xFF)
	{
	  ...
	  if (! MATCHES_NEWLINE_CONTEXT(pos.constraint,
	    ...
	    for (/*binOp start*/j = /*binOp end*/0; /*binOp start*/j < CHARCLASS_INTS; ++j)
	  ...
	  for (/*binOp start*/j = /*binOp end*/0; /*binOp start*//*binOp start*/j < CHARCLASS_INTS && !matches[j/*binOp end*/]; ++j)
	    ;
	  if (/*binOp start*/j == CHARCLASS_INTS)
	    continue;
	}
      ...
      for (/*binOp start*/j = /*binOp end*/0; /*binOp start*/j < /*binOp end*/ngrps; ++j)
	{
	  /* If matches contains a single character only, and the current
	     ...
	     next group. */
	  if (/*binOp start*//*binOp start*//*binOp start*/d->tokens[pos.index] >= /*binOp end*/0 && /*binOp start*/d->tokens[pos.index] < NOTCHAR
	      && !tstbit(d->tokens[pos.index], labels[j]/*binOp end*/))
	    continue;

	  /* Check if this group's label has a nonempty intersection with
	     matches. */
	  /*compound start*//*binOp start*/intersectf = /*compound end*//*binOp end*/0;
	  for (/*binOp start*/k = /*binOp end*/0; /*binOp start*/k < CHARCLASS_INTS; ++k)
  ...
  for (/*binOp start*/i = /*binOp end*/0; /*binOp start*/i < /*binOp end*/ngrps; ++i)
	...
	for (/*binOp start*/k = /*binOp end*/0; /*binOp start*/k < d->follows[grps[i].elems[j].index]./*binOp end*/nelem; ++k)
     ...
     struct dfa *d;
{
	...
	if (d->trans[i])
	  {
	    ...
	    /*compound start*//*binOp start*/d->trans[i] = NULL;
	  }
	else if (d->fails[i])
	  {
	    free((ptr_t) d->fails[i]);
	    /*compound start*//*binOp start*/d->fails[i] = NULL;
	  }
  ...
  for (/*binOp start*/i = /*binOp end*/0; /*binOp start*/i < NOTCHAR; ++i)
	...
	while (/*binOp start*/oldalloc < d->/*binOp end*/tralloc)
	  {
	    /*compound start*//*binOp start*/d->trans[oldalloc] = NULL;
	    /*compound start*//*binOp start*/d->fails[oldalloc++] = NULL;
	  }
      }
     ...
     char *new;
{
  ...
  /*compound start*//*binOp start*/newsize = (/*binOp start*/new == NULL) ? 0 : strlen(new/*compound end*//*binOp end*/);
  if (/*binOp start*/old == NULL)
  ...
  if (/*binOp start*//*binOp start*/result != NULL && /*binOp start*/new != NULL)
     ...
     char **cpp;
{
  ...
  if (/*binOp start*/cpp == NULL)
    return;
  for (/*binOp start*/i = /*binOp end*/0; /*binOp start*/cpp[i] != NULL; ++i)
    {
      free(cpp[i]);
      /*compound start*//*binOp start*/cpp[i] = NULL;
    }
}
     ...
     int len;
{
  ...
  if (/*binOp start*/cpp == NULL)
    return NULL;
  if (/*binOp start*/(/*binOp start*/new = icpyalloc(new/*binOp end*/)) == NULL)
    {
      freelist(cpp);
      return NULL;
    }
  ...
  for (/*binOp start*/i = /*binOp end*/0; /*binOp start*/cpp[i] != NULL; ++i)
    if (/*binOp start*/istrstr(cpp[i], new) != NULL)
      {
	free(new);
	return cpp;
      }
  ...
  while (/*binOp start*/cpp[j] != NULL)
    if (/*binOp start*/istrstr(new, cpp[j]) == NULL)
      ++j;
    else
      {
	free(cpp[j]);
  ...
  /*compound start*//*binOp start*/cpp[/*binOp start*/i + /*binOp end*/1] = NULL;
  return cpp;
}
     ...
     char *right;
{
  ...
  if (/*binOp start*//*binOp start*/left == NULL || /*binOp start*/right == NULL)
    return NULL;
  /*compound start*//*binOp start*/cpp = (char **) malloc(sizeof *cpp/*compound end*//*binOp end*/);
  if (/*binOp start*/cpp == NULL)
    return NULL;
  /*compound start*//*binOp start*/cpp[0] = NULL;
  for (/*binOp start*/lcp = /*binOp end*/left; /*binOp start*/*lcp != /*binOp end*/'\0'; ++lcp)
    {
      ...
      /*compound start*//*binOp start*/rcp = index(right, *lcp/*compound end*//*binOp end*/);
      while (/*binOp start*/rcp != NULL)
	{
	  ...
	  /*compound start*//*binOp start*/rcp = index(/*binOp start*/rcp + /*binOp end*/1, *lcp/*compound end*//*binOp end*/);
	}
      if (/*binOp start*/len == /*binOp end*/0)
	continue;
      if (/*binOp start*/(/*binOp start*/cpp = enlist(cpp, lcp, len/*binOp end*/)) == NULL)
	break;
    }
  return cpp;
}
...
char **new;
{
  ...
  if (/*binOp start*//*binOp start*/old == NULL || /*binOp start*/new == NULL)
    return NULL;
  for (/*binOp start*/i = /*binOp end*/0; /*binOp start*/new[i] != NULL; ++i)
    {
     ...
     char **right;
{
  ...
  if (/*binOp start*/both == NULL)
    return NULL;
  /*compound start*//*binOp start*/both[0] = NULL;
  for (/*binOp start*/lnum = /*binOp end*/0; /*binOp start*/left[lnum] != NULL; ++lnum)
    {
      for (/*binOp start*/rnum = /*binOp end*/0; /*binOp start*/right[rnum] != NULL; ++rnum)
	{
	  /*compound start*//*binOp start*/temp = comsubs(left[lnum], right[rnum]/*compound end*//*binOp end*/);
	  if (/*binOp start*/temp == NULL)
	    {
	      freelist(both);
	      return NULL;
	    }
  ...
  for (/*binOp start*/i = /*binOp end*/0; /*binOp start*/i <= dfa->/*binOp end*/tindex; ++i)
    {
      ...
      if (/*binOp start*//*binOp start*//*binOp start*//*binOp start*/mp[i].in == NULL || /*binOp start*/mp[i].left == NULL ||
	  /*binOp start*/mp[i].right == NULL || /*binOp start*/mp[i].is == NULL)
	goto done;
      ...
      /*compound start*//*binOp start*/mp[i].in[0] = NULL;
    }
#ifdef DEBUG
  ...
  for (/*binOp start*/ri = /*binOp end*/0; /*binOp start*/ri < dfa->/*binOp end*/tindex; ++ri)
	...
	case END:
	  if (/*binOp start*/mp != &musts[1/*binOp end*/])
	    goto done;		/* "cannot happen" */
	  for (/*binOp start*/i = /*binOp end*/0; /*binOp start*/musts[0].in[i] != NULL; ++i)
     ...
     char *trans;
{
  ...
  /*compound start*//*binOp start*/kwset = (struct kwset *) malloc(sizeof (struct kwset)/*compound end*//*binOp end*/);
  if (!kwset)
    return 0;
  ...
  if (/*binOp start*//*binOp start*/kwset->words == /*binOp end*/1 && /*binOp start*/kwset->trans == /*binOp end*//*binOp end*/0)
    {
      ...
      /*compound start*//*binOp start*/kwset->target = obstack_alloc(&kwset->obstack, kwset->mind);
     ...
     void (*freefun) ();
{
  ...
  if (/*binOp start*/size == /*binOp end*/0)
    /* Default size is what GNU malloc can fit in a 4096-byte block.  */
    {
	 ...
	 less sensitive to the size of the request.  */
      int extra = (/*binOp start*/(/*binOp start*//*binOp start*//*binOp start*/(/*binOp start*/(/*binOp start*//*binOp start*/12 + DEFAULT_ROUNDING - /*binOp end*/1) & ~(DEFAULT_ROUNDING - /*binOp end*/1/*binOp end*/))
		    + /*binOp end*/4 + DEFAULT_ROUNDING - /*binOp end*/1)
		   & ~(DEFAULT_ROUNDING - /*binOp end*/1/*binOp end*/));
      /*compound start*//*binOp start*/size = /*binOp start*/4096 - /*compound end*//*binOp end*//*binOp end*/extra;
    }

  /*compound start*//*binOp start*/h->chunkfun = (struct _obstack_chunk * (*)()) /*compound end*//*binOp end*/chunkfun;
  /*compound start*//*binOp start*/h->freefun = /*compound end*//*binOp end*/freefun;
  /*compound start*//*binOp start*/h->chunk_size = /*compound end*//*binOp end*/size;
  /*compound start*//*binOp start*/h->alignment_mask = /*binOp start*/alignment - /*compound end*//*binOp end*//*binOp end*/1;
  /*compound start*//*binOp start*/h->use_extra_arg = /*compound end*//*binOp end*/0;

  /*compound start*//*binOp start*/chunk = /*binOp start*/h->chunk = CALL_CHUNKFUN (h, h -> chunk_size);
  /*compound start*//*binOp start*/h->next_free = /*binOp start*/h->object_base = chunk->/*compound end*//*binOp end*//*binOp end*/contents;
  /*compound start*//*binOp start*/h->chunk_limit = /*binOp start*/chunk->limit
    = /*binOp start*/(char *) chunk + h->/*compound end*//*binOp end*//*binOp end*//*binOp end*/chunk_size;
  /*compound start*//*binOp start*/chunk->prev = /*compound end*//*binOp end*/0;
  /* The initial chunk now contains no empty object.  */
  /*compound start*//*binOp start*/h->maybe_empty_object = /*compound end*//*binOp end*/0;
}
     ...
     POINTER arg;
{
  ...
  /*compound start*//*binOp start*/h->chunk_size = /*compound end*//*binOp end*/size;
  /*compound start*//*binOp start*/h->alignment_mask = /*binOp start*/alignment - /*compound end*//*binOp end*//*binOp end*/1;
  /*compound start*//*binOp start*/h->extra_arg = /*compound end*//*binOp end*/arg;
  /*compound start*//*binOp start*/h->use_extra_arg = /*compound end*//*binOp end*/1;
     ...
     int length;
{
  ...
  register int obj_size = /*binOp start*/h->next_free - h->/*binOp end*/object_base;
  register int i;
  int already;

  /* Compute size for new chunk.  */
  /*compound start*//*binOp start*/new_size = /*binOp start*//*binOp start*/(/*binOp start*/obj_size + /*binOp end*/length) + (/*binOp start*/obj_size >> /*binOp end*/3/*binOp end*/) + /*compound end*//*binOp end*//*binOp end*/100;
  if (/*binOp start*/new_size < h->/*binOp end*/chunk_size)
    /*binOp start*/new_size = h->/*binOp end*/chunk_size;

  /* Allocate and initialize the new chunk.  */
  /*compound start*//*binOp start*/new_chunk = /*binOp start*/h->chunk = CALL_CHUNKFUN (h, new_size);
  /*compound start*//*binOp start*/new_chunk->prev = /*compound end*//*binOp end*/old_chunk;
  /*compound start*//*binOp start*/new_chunk->limit = /*binOp start*/h->chunk_limit = /*binOp start*/(char *) new_chunk + /*compound end*//*binOp end*//*binOp end*//*binOp end*/new_size;
  ...
  for (/*binOp start*/i = /*binOp end*/already; /*binOp start*/i < /*binOp end*/obj_size; i++)
    /*binOp start*/new_chunk->contents[i] = h->object_base[i/*binOp end*/];

  /* If the object just copied was the only data in OLD_CHUNK,
     free that chunk and remove it from the chain.
     But not if that chunk might contain an empty object.  */
  if (/*binOp start*//*binOp start*/h->object_base == old_chunk->/*binOp end*/contents && ! h->/*binOp end*/maybe_empty_object)
    {
      /*compound start*//*binOp start*/new_chunk->prev = old_chunk->/*compound end*//*binOp end*/prev;
      CALL_FREEFUN (h, old_chunk);
    }

  /*compound start*//*binOp start*/h->object_base = new_chunk->/*compound end*//*binOp end*/contents;
  /*compound start*//*binOp start*/h->next_free = /*binOp start*/h->object_base + /*compound end*//*binOp end*//*binOp end*/obj_size;
     ...
     POINTER obj;
{
  ...
  /*compound start*//*binOp start*/lp = (h)->/*compound end*//*binOp end*/chunk;
  /* We use >= rather than > since the object cannot be exactly at
     the beginning of the chunk but might be an empty object exactly
     at the end of an adjacent chunk. */
  while (/*binOp start*//*binOp start*/lp != /*binOp end*/0 && (/*binOp start*//*binOp start*/(POINTER)lp >= /*binOp end*/obj || /*binOp start*/(POINTER)(lp)->limit < /*binOp end*//*binOp end*/obj/*binOp end*/))
    {
      /*compound start*//*binOp start*/plp = lp->/*compound end*//*binOp end*/prev;
      /*compound start*//*binOp start*/lp = /*compound end*//*binOp end*/plp;
    }
  return /*binOp start*/lp != /*binOp end*/0;
}

  ...
  while (/*binOp start*//*binOp start*/lp != /*binOp end*/0 && (/*binOp start*//*binOp start*/(POINTER)lp >= /*binOp end*/obj || /*binOp start*/(POINTER)(lp)->limit < /*binOp end*//*binOp end*/obj/*binOp end*/))
    {
	 ...
	 chunk contains an empty object, so assume that it may.  */
      /*compound start*//*binOp start*/h->maybe_empty_object = /*compound end*//*binOp end*/1;
    }
  if (lp)
    {
      /*compound start*//*binOp start*/h->object_base = /*binOp start*/h->next_free = (char *)(obj/*compound end*//*binOp end*//*binOp end*/);
      /*compound start*//*binOp start*/h->chunk_limit = lp->/*compound end*//*binOp end*/limit;
      /*compound start*//*binOp start*/h->chunk = /*compound end*//*binOp end*/lp;
    }
  else if (/*binOp start*/obj != /*binOp end*/0)
